...
### 微調前（baseline，測試集 22 題）

| 題型 | N | Exact Match | Cosine Similarity |
|------|---|-------------|-------------------|
| 單選題 | 8 | 12.5% | 0.604 |
| 多選題 | 4 | 0.0% | 0.553 |
| 是非題 | 10 | 30.0% | 0.641 |
| **Overall** | **22** | **18.2%** | **0.612** |
...
| 多選題 | 4 | 0.0% | 0.909 |
| 是非題 | 5 | 20.0% | 0.656 |
| **Overall** | **15** | **26.7%** | **0.805** |

> **注意**：兩次評測使用的測試集版本不同（22 題 vs 15 題），數字僅供趨勢參考，非嚴格對照實驗。最終版測試集見 `data/splunk_testset.csv`。

### 結果解讀

- **單選題**：EM 從 12.5% 大幅提升至 50%，Cosine 也從 0.60 升至 0.86，微調效果最明顯
- **多選題**：EM 維持 0%，但 Cosine 從 0.55 上升至 0.91，代表模型語意上已理解正確答案，仍是**格式問題**（換行分隔未完全學會）
- **是非題**：Cosine 相近，微調對此題型改善有限，推測與訓練資料中是非題比例較少有關
